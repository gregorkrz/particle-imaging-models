...
def main(argv: list[str] | None = None) -> int:
    ...
    cfg["executor"] = "local"
    # Record the exact user-facing command so the run can be reproduced (the
    # training engine folds this into the run config / run_metadata.json).
