#!/bin/bash
#SBATCH --job-name=vtx-dec-insseg-v1m1
#SBATCH --nodes=2
...
CONFIG="detector-v1m1-pt-v3m2-ft-vtx-dec"
...
TRAIN_PATH=/sdf/home/y/youngsam/sw/dune/representatixons/particle-imaging-models/scripts/train.sh
