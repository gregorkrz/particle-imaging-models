...
# scheduler settings
epoch = 40 * (1_000_000 // num_events)
wandb_run_name = f"hmae-v1m1-pilarnet-pretrain-{num_events}ev-amp-seed{seed}-{epoch}epoch"
...
data = dict(
    ...
    test=dict(
        ...
        transform=[
            ...
            dict(type="Copy", keys_dict={"coord": "origin_coord", "segment_motif": "segment"}),
            ...
            dict(
                ...
                keys=(
                    ...
                    "coord", "grid_coord", "energy", "inverse", "segment"
                ),
                offset_keys_dict=dict(
                    visible_offset="visible_coord",
                    masked_offset="masked_centroids",
