...
model = dict(
    ...
    backbone=dict(
        ...
        enc_channels=(32, 48, 96, 192, 384),
        enc_num_head=(2, 3, 6, 12, 24),
...
transform = [
    ...
    dict(
        ...
        global_transform=[
            ...
            # dict(type="RandomDrop", key="energy", p_apply=0.2, p_drop=0.5, value=0.0),
            # dict(type="RandomDrop", key="coord", p_apply=0.2, p_drop=0.5, value=0.0),
