...
__version__ = runpy.run_path("pytorch3d_ops/__init__.py")["__version__"]
...
setup(
    ...
    description="Minimal subset of PyTorch3D (FAIR) containing only "
    "ball_query, sample_farthest_points, knn, and chamfer_distance.",
